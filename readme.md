...
* [PRIMO WatchDog](https://github.com/marcelinohermida/PRIMO_WatchDog)- ![Static Badge](https://img.shields.io/badge/Python-stuff?style=flat&logo=python&color=lime) PRIMO WatchDog is a set of Python scripts to automate the Monte Carlo simulations of clinical IMRT, VMAT and DCA plans with the PRIMO Monte Carlo software (https://primoproject.net/primo/), with a minimal workload for the medical physicist. This facilitates introducing PRIMO as a routine, automated system for independent verifications.
